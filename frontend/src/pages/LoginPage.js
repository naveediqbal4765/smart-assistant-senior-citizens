...
const LoginPage = () => {
  ...
  // ============================================================
  return (
    <div className="page-bg flex items-center justify-center min-h-screen p-4" style={{ fontFamily: "Montserrat, sans-serif" }}>
      ...
      <div className="w-full max-w-5xl flex flex-col md:flex-row items-center gap-8 md:gap-16 animate-fade-in" style={{ marginTop: "45px" }}>
        ...
        <div className="flex-1 flex flex-col items-center md:items-start text-center md:text-left">
          ...
          {/* App Title */}
          <h1
            style={{ fontWeight: 800, fontSize: "2.4rem", color: "#1C382A", lineHeight: 1.2, marginBottom: "1rem", fontFamily: "Montserrat, sans-serif" }}
          >
            Smart Assistant for<br />Senior Citizens
          </h1>

          {/* Description (Lorem Ipsum placeholder as in UI) */}
          <p style={{ fontSize: "1rem", color: "#1C382A", lineHeight: 1.7, maxWidth: "380px", fontFamily: "Montserrat, sans-serif" }}>
            <span style={{ color: "#1C382A", fontWeight: 700 }}>Lorem Ipsum</span> is simply dummy text of
        ...
        <div
          ...
          style={{ width: "1px", height: "340px", backgroundColor: "#1C382A4D" }}
        />
          ...
          >
            ...
            <form onSubmit={handleLogin} noValidate>
              ...
              <div style={{ marginBottom: "16px" }}>
                <label style={{ display: "block", fontSize: "1rem", fontWeight: 600, color: "#1C382A", marginBottom: "8px", fontFamily: "Montserrat, sans-serif" }} htmlFor="email">
                  Username / Email
                </label>
                <input
                  id="email"
                ...
                />
                {errors.email && (
                  <p style={{ color: "#e63946", fontSize: "0.85rem", fontWeight: 600, marginTop: "4px", fontFamily: "Montserrat, sans-serif" }}>⚠️ {errors.email}</p>
                )}
              </div>

              {/* Password Field */}
              <div style={{ marginBottom: "20px" }}>
                <label style={{ display: "block", fontSize: "1rem", fontWeight: 600, color: "#1C382A", marginBottom: "8px", fontFamily: "Montserrat, sans-serif" }} htmlFor="password">
                  Password
                </label>
                <input
                  id="password"
                ...
                />
                {errors.password && (
                  <p style={{ color: "#e63946", fontSize: "0.85rem", fontWeight: 600, marginTop: "4px", fontFamily: "Montserrat, sans-serif" }}>⚠️ {errors.password}</p>
                )}
              </div>
              ...
              >
                ...
                >
                  <input
                    ...
                    onChange={handleChange}
                    style={{ width: "18px", height: "18px", cursor: "pointer", accentColor: "#1C382A", border: "none" }}
                  />
                  Remember me
                </label>
              ...
              >
                <div style={{ flex: 1, height: "1px", backgroundColor: "#1C382A4D" }} />
                <span style={{ color: "#1C382A", fontSize: "0.9rem", fontWeight: 500, fontFamily: "Montserrat, sans-serif" }}>OR</span>
                <div style={{ flex: 1, height: "1px", backgroundColor: "#1C382A4D" }} />
              </div>
